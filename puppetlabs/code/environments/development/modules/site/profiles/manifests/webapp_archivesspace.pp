...
class profiles::webapp_archivesspace (
  $ensure = lookup('archivesspace::ensure', Boolean, 'first'),
  ...
  $conf_file      = lookup('archivesspace::conf_file', String, 'first'),
  $java_heap_max  = lookup('archivesspace::java_heap_max', String, 'first'),
  $log_level      = lookup('archivesspace::log_level', String, 'first'),
  $enable_backend = lookup('archivesspace::enable_backend', String, 'first'),
  $enable_frontend = lookup('archivesspace::enable_frontend', String, 'first'),
  $enable_public   = lookup('archivesspace::enable_public', String, 'first'),
  $enable_solr     = lookup('archivesspace::enable_solr', String, 'first'),
  $enable_indexer  = lookup('archivesspace::enable_indexer', String, 'first'),
  $enable_docs     = lookup('archivesspace::enable_docs', String, 'first'),
  $enable_oai      = lookup('archivesspace::enable_oai', String, 'first'),
  $fsdb            = lookup('archivesspace::fsdb', String, 'first'),
  ...
  $plugin          = lookup('archivesspace::plugin', String, 'first'),
  $plugin_conf     = lookup('archivesspace::plugin_conf', String, 'first'),
  $plugin_install_dir = lookup('archivesspace::plugin_install_dir', String, 'first'),
  $plugin_ensure   = lookup('archivesspace::plugin_ensure', String, 'first'),
  $plugin_prefix   = lookup('archivesspace::plugin_prefix', String, 'first'),
  $plugin_revision = lookup('archivesspace::plugin_revision', String, 'first'),
  $plugin_source   = lookup('archivesspace::plugin_source', String, 'first'),
  $plugin_marcxml_export_revision = lookup('archivesspace::plugin_marcxml_export_revision', String, 'first'),
  $plugin_ead_export_revision     = lookup('archivesspace::plugin_ead_export_revision', String, 'first'),
  $plugin_sso_revision            = lookup('archivesspace::plugin_sso_revision', String, 'first'),
) {
